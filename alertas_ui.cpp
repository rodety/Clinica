    ...
    ui(new Ui::alertas_ui)
{
    ...
    //update_table_alert();
    ui->tableWidget_AlertList->setEditTriggers(QAbstractItemView::NoEditTriggers);
...
void alertas_ui::on_editar_alerta_clicked()
{
    ...
    EDIT_ALERT_FORM->setParentWindow(parentWindow);
    EDIT_ALERT_FORM->setcodeWindow(parentWindow->getcodeWindow());
...
void alertas_ui::on_newAlert_alerta_clicked()
{
    ...
    NEW_ALERTA_FORM->setParentWindow(parentWindow);
    NEW_ALERTA_FORM->setcodeWindow(parentWindow->getcodeWindow());
...
void alertas_ui::setParentPrincipal(MainWindow *parent)
{
    parentWindow=parent;
}
