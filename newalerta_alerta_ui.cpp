...
void newalerta_alerta_ui::setParentWindow(MainWindow *parent)
{
    parentWindow=parent;
}

void newalerta_alerta_ui::setcodeWindow(int code)
{
    codeWindow=code;
}

bool newalerta_alerta_ui::changeParentWindow(int code)
{
