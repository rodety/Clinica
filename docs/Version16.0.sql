...
ALTER TABLE e_antecedentes ADD CONSTRAINT Relationship53 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE e_consulta ADD CONSTRAINT Relationship54 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE e_reporte_operatorio ADD CONSTRAINT Relationship57 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE e_examen_clinico ADD CONSTRAINT Relationship60 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE e_epicrisis ADD CONSTRAINT Relationship67 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE E_RIESGO_QUIRURGICO ADD CONSTRAINT Relationship69 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE e_terapeutica_medica ADD CONSTRAINT Relationship81 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES r_historial_documento (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE datos_terapeutica ADD CONSTRAINT Relationship87 FOREIGN KEY (historial_documento_pk, historia_clinica_pk) REFERENCES e_terapeutica_medica (historial_documento_pk, historia_clinica_pk) ON DELETE NO ACTION ON UPDATE NO ACTION
;
