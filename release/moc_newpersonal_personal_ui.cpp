...
**
** Created: Sat 11. Jun 15:34:38 2016
...
void newpersonal_personal_ui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        newpersonal_personal_ui *_t = static_cast<newpersonal_personal_ui *>(_o);
        switch (_id) {
        ...
        case 3: _t->on_comboBox_tipo_activated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->on_comboBox_tipo_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->on_lineEdit_Dni_cursorPositionChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 6: _t->on_lineEdit_Dni_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData newpersonal_personal_ui::staticMetaObjectExtraData = {
...
const QMetaObject newpersonal_personal_ui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_newpersonal_personal_ui,
      qt_meta_data_newpersonal_personal_ui, &staticMetaObjectExtraData }
};
